...
/**
 * <code>DocumentTranslationRequestData</code> provides read access to the document translation request's
 * properties.
 * 
 * @author jugudanniesundar
 */
public abstract class DocumentTranslationRequestData {
     ...
     * @param targetLanguagesMap   The map containing target languages indexed by document type and ids.
     ...
     * @param updatedBy The last user updated this document's properties.
     * @param updatedAt The last date when this document's properties were updated.
     */
    protected DocumentTranslationRequestData(String id, String partner, Map<String, Map<String, Set<String>>> targetLanguagesMap,
    ...
    /**
     * Returns the last user updated this document's properties.
     * This method always returns non-null date.
     * 
     * @return The last user updated this document's properties.
     */
    ...
    /**
     * Returns the last date when this document's properties were updated.
     * This method always returns non-null date.
     * 
     * @return The last date when this document's properties were updated.
     */
     ...
     */
    public abstract Map<String, Map<String, WordCountData>> getWordCountData();
